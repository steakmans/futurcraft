...
@OnlyIn(Dist.CLIENT)
public class NuclearMissileRenderer<Type extends NuclearMissileEntity> extends EntityRenderer<NuclearMissileEntity> {
    ...
    @Override
    public void render(NuclearMissileEntity entity, float p_116178_, float p_116179_, PoseStack stack, MultiBufferSource buf, int p_116182_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(NuclearMissileEntity p_114482_) {
