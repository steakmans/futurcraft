...
@OnlyIn(Dist.CLIENT)
public class IncendiaryGrenadeRenderer<Type extends IncendiaryGrenade> extends EntityRenderer<IncendiaryGrenade> {


    public IncendiaryGrenadeRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }

    @Override
    public void render(IncendiaryGrenade p_116177_, float p_116178_, float p_116179_, PoseStack p_116180_, MultiBufferSource p_116181_, int p_116182_) {
        p_116180_.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(IncendiaryGrenade p_114482_) {
