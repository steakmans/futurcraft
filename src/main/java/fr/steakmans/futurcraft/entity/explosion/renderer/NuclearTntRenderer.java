...
@OnlyIn(Dist.CLIENT)
public class NuclearTntRenderer<Type extends NuclearPrimedTnt> extends EntityRenderer<NuclearPrimedTnt> {


    public NuclearTntRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }

    @Override
    public void render(NuclearPrimedTnt p_116177_, float p_116178_, float p_116179_, PoseStack p_116180_, MultiBufferSource p_116181_, int p_116182_) {
        p_116180_.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(NuclearPrimedTnt p_114482_) {
