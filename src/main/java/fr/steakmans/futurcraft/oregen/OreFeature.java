...
public class OreFeature {
    ...
    public static void registerOreFeatures() {
        ...
        OVERWORLD_ALUMINUM_GEN = registerPlacedOreFeature("overworld_aluminum_ore", new ConfiguredFeature<>(Feature.ORE, overworldAluminumConfig), CountPlacement.of(9), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(64)));
        OVERWORLD_DEEP_ALUMINUM_GEN = registerPlacedOreFeature("overworld_deepslate_aluminum_ore", new ConfiguredFeature<>(Feature.ORE, overworldDeepAluminumConfig), CountPlacement.of(9), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(0)));
        OVERWORLD_SILVER_GEN = registerPlacedOreFeature("overworld_silver_ore", new ConfiguredFeature<>(Feature.ORE, overworldSilverConfig), CountPlacement.of(12), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(70)));
        OVERWORLD_DEEP_SILVER_GEN = registerPlacedOreFeature("overworld_deepslate_silver_ore", new ConfiguredFeature<>(Feature.ORE, overworldDeepSilverConfig), CountPlacement.of(5), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-32), VerticalAnchor.absolute(0)));
        OVERWORLD_TITANIUM_GEN = registerPlacedOreFeature("overworld_titanium_ore", new ConfiguredFeature<>(Feature.ORE, overworldTitaniumConfig), CountPlacement.of(6), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(48)));
        OVERWORLD_DEEP_TITANIUM_GEN = registerPlacedOreFeature("overworld_deepslate_titanium_ore", new ConfiguredFeature<>(Feature.ORE, overworldDeepTitaniumConfig), CountPlacement.of(7), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-48), VerticalAnchor.absolute(0)));
        ...
        OVERWORLD_DEEP_COBALT_GEN = registerPlacedOreFeature("overworld_deepslate_cobalt", new ConfiguredFeature<>(Feature.ORE, overworldDeepCobaltConfig), CountPlacement.of(4), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-16)));
        ...
        OVERWORLD_DEEP_NICKEL_GEN = registerPlacedOreFeature("overworld_deepslate_nickel_ore", new ConfiguredFeature<>(Feature.ORE, overworldDeepNickelConfig), CountPlacement.of(3), InSquarePlacement.spread(), BiomeFilter.biome(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-64), VerticalAnchor.absolute(-32)));
    }
