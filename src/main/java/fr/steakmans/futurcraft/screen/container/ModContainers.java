...
public class ModContainers {
    ...
    public static final RegistryObject<MenuType<LauncherPanelContainer>> LAUNCHER_PANEL = CONTAINERS.register("launcher_panel", () -> new MenuType<>(LauncherPanelContainer::new));
